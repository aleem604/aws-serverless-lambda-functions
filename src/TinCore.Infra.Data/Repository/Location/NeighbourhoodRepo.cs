...
{
    public class NeighbourhoodRepo : Repository<Neighbourhood>, INeighbourhoodRepo
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfiguration _configuration;

        public NeighbourhoodRepo(TinCoreContext context, IHostingEnvironment env, IConfiguration configuration)
            : base(context)
        {
            _env = env;
