...
{
    public class VLocationRepo : Repository<VLocation>, IVLocationRepo
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfiguration _configuration;

        public VLocationRepo(TinCoreContext context, IHostingEnvironment env, IConfiguration configuration)
            : base(context)
        {
            _env = env;
