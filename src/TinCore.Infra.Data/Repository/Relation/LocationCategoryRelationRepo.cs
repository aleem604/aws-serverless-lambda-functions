...
{
    public class LocationCategoryRelationRepo : Repository<LocationCategoryRelation>, ILocationCategoryRelationRepo
    {
        private readonly IConfiguration _configuration;

        public LocationCategoryRelationRepo(TinCoreContext context, IConfiguration configuration)
            : base(context)
        {
