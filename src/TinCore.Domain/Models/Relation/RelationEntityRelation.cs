...
{
    [Table("relation_entity_relation")]
    public class RelationEntityRelation : BaseEntity
    {
        [Column("entity1_id")]
        ...
        public eRelationTypes RelationType { get; set; } = eRelationTypes.RELATION_RELATION;
