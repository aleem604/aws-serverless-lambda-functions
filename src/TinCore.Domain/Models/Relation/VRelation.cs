...
{
    [Table("v_relation")]
    public class VRelation
    {
        public long Id { get; set; }
        [Column("entity1_id")]
        public long Entity1Id { get; set; }
        [Column("entity1_type")]
        public eEoTypes Entity1Type { get; set; }
        [Column("entity1_subtype")]
        public eEoSubTypes Entity1Subtype { get; set; }
        [Column("entity2_id")]
        public long Entity2Id { get; set; }
        [Column("entity2_type")]
        public eEoTypes Entity2Type { get; set; }
        [Column("entity2_subtype")]
        public eEoSubTypes Entity2Subtype { get; set; }
        [Column("relation_type")]
        public eRelationTypes RelationType { get; set; }
