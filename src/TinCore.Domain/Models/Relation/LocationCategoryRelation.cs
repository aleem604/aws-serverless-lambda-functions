...
{
    [Table("location_category_relation")]
    public class LocationCategoryRelation : BaseEntity
    {
        [Column("entity1_id")]
        ...
        public eRelationTypes RelationType { get; set; } = eRelationTypes.LOCATION_CATEGORY;
