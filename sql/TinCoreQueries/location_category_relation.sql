...
-- 2710	 RELATION~LOCATION_CATEGORY

-- =========================================
USE ProManDB
GO

IF OBJECT_ID('dbo.location_category_relation', 'U') IS NOT NULL
  DROP TABLE dbo.location_category_relation
GO

CREATE TABLE [dbo].[location_category_relation](
	[id] [bigint] IDENTITY(200001,1) NOT NULL,
 ...
 CONSTRAINT [PK_location_category_relation] PRIMARY KEY CLUSTERED 
(
	[id] ASC
...
SET IDENTITY_INSERT dbo.location_category_relation ON

insert into [dbo].[location_category_relation] (id, entity1_id, entity1_type, entity1_subtype, entity2_id, entity2_type, entity2_subtype, relation_type, relation_subtype, 
...
from relations where relation_type = 2710


SET IDENTITY_INSERT dbo.location_category_relation OFF

--  select * from location_category_relation order by 1 desc
