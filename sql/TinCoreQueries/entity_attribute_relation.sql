...
-- 2711	 RELATION~EO_ATTRIBUTE
-- =========================================
USE ProManDB
GO

IF OBJECT_ID('dbo.entity_attribute_relation', 'U') IS NOT NULL
  DROP TABLE dbo.entity_attribute_relation
GO

CREATE TABLE [dbo].[entity_attribute_relation](
 ...
 CONSTRAINT [PK_entity_attribute_relation] PRIMARY KEY CLUSTERED 
(
	[id] ASC
...
SET IDENTITY_INSERT dbo.entity_attribute_relation ON

insert into [dbo].[entity_attribute_relation] (id, entity1_id, entity1_type, entity1_subtype, entity2_id, entity2_type, entity2_subtype, relation_type, relation_subtype, 
...
from relations where relation_type = 2711


SET IDENTITY_INSERT dbo.entity_attribute_relation OFF

--  select * from entity_attribute_relation order by 1 desc
