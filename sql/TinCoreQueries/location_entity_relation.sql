...
-- 2712	 RELATION~LOCATION_EO

-- =========================================
USE ProManDB
GO

IF OBJECT_ID('dbo.location_entity_relation', 'U') IS NOT NULL
  DROP TABLE dbo.location_entity_relation
GO

CREATE TABLE [dbo].[location_entity_relation](
 ...
 CONSTRAINT [PK_location_entity_relation] PRIMARY KEY CLUSTERED 
(
	[id] ASC
...
SET IDENTITY_INSERT dbo.location_entity_relation ON

insert into [dbo].[location_entity_relation] (id, entity1_id, entity1_type, entity1_subtype, entity2_id, entity2_type, entity2_subtype, relation_type, relation_subtype, 
...
from relations where relation_type = 2712


SET IDENTITY_INSERT dbo.location_entity_relation OFF

--  select * from location_entity_relation order by 1 desc
